...
#note:this procedure doesnt check whether the keyword already exists ..directly appends it to the appropriate bucket..but idealy it should check whether the keyword is already present and then append the key and value
